...
class PCoAAnalyzer:
    ...
    def plot_pcoa_with_ellipses(self, figsize=(12, 8), show_labels=True, save_path=None):
        ...
        ax.set_xlabel(f'PCo1 ({variance_exp[0]:.2f}%)', fontsize=12, fontweight='bold')
        ax.set_ylabel(f'PCo2 ({variance_exp[1]:.2f}%)', fontsize=12, fontweight='bold')
...
def main():
    ...
    # 加载数据（请修改为您的文件路径）
    try:
        df = analyzer.load_data('C:/Users/Lenovo/Desktop/major_ARGs.csv',
